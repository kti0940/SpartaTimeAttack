...
class JobPostActivityStatusSerializer(serializers.ModelSerializer):
    
    class Meta:
        model = jobPostActivatiStatus
        field = '__all__'

class JobPostActivitySerializer(serializers.ModelSerializer):
    job_post_status = JobPostActivityStatusSerializer()
